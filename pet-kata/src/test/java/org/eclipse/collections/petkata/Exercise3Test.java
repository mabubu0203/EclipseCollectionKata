...
//        Assert.fail("Optimize this test by using a Bag with variable name 'counts'");
        ...
        MutableBag<PetType> counts = Bags.mutable.empty();
...
//        Assert.fail("Optimize this test by using a Multimap");
        ...
        MutableMultimap<String, Person> byLastNameMultimap = Multimaps.mutable.list.empty();
        this.people.groupBy(person -> byLastNameMultimap.add(Tuples.pair(person.getLastName(), person)));
...
//        MutableMap<PetType, MutableSet<Person>> peopleByPetType = Maps.mutable.empty();
        MutableSetMultimap<PetType, Person> peopleByPetType = Multimaps.mutable.set.empty();
